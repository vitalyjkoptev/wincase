    ...
    <div class="card">
        <div class="card-body p-4 p-md-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="empStatus" required>
                            <option value="" data-lang="wc-reg-select">Select...</option>
                            <option value="Umowa o prace" data-lang="wc-reg-emp-prace">Employed (Umowa o pracę)</option>
                            <option value="Umowa zlecenie" data-lang="wc-reg-emp-zlecenie">Employed (Umowa zlecenie)</option>
                            <option value="Umowa o dzielo" data-lang="wc-reg-emp-dzielo">Employed (Umowa o dzieło)</option>
                            <option value="Self-Employed" data-lang="wc-reg-emp-self">Self-Employed (Działalność)</option>
                            <option value="Business Owner" data-lang="wc-reg-emp-owner">Business Owner (Spółka)</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="workPermit">
                            ...
                            <option value="Declaration" data-lang="wc-reg-wp-declaration">Employer's Declaration (Oświadczenie)</option>
            ...
            <div class="wizard-panel" data-panel="7">
                ...
                <div class="mb-4">
                    <h6 class="fw-semibold"><i class="ri-draft-line me-1"></i><span data-lang="wc-reg-poa-title">3. Power of Attorney (Pełnomocnictwo)</span></h6>
                    <div class="agreement-box">
...
(function(){
    ...
    function collectFormData() {
        ...
        return {
            // Step 1
            first_name: v('firstName'), last_name: v('lastName'), middle_name: v('middleName'),
            maiden_name: v('maidenName'), date_of_birth: v('dob'), place_of_birth: v('birthPlace'),
            gender: v('gender'), nationality: v('nationality'), citizenship: v('citizenship'),
            phone: v('phone'), phone2: v('phone2'), messenger: v('messenger'),
            email: v('email'), password: v('regPassword'), preferred_language: v('prefLang'),
            // Step 2
            passport_number: v('passportNo'), passport_issue_date: v('passportIssue'),
            passport_expiry_date: v('passportExpiry'), passport_authority: v('passportAuthority'),
            passport_country: v('passportCountry'), pesel: v('pesel'), nip: v('nip'),
            regon: v('regon'), national_id: v('nationalId'), driver_license: v('driverLicense'),
            prev_passport: v('prevPassport'), zus_number: v('zus'),
            // Step 3
            pl_street: v('plStreet'), pl_apartment: v('plApt'), pl_postal_code: v('plPostal'),
            pl_city: v('plCity'), pl_voivodeship: v('plVoivodeship'), zameldowanie: v('zameldowanie'),
            pl_living_since: v('plLivingSince'), home_address: v('homeAddress'),
            home_country: v('homeCountry'), home_phone: v('homePhone'),
            same_correspondence_address: document.getElementById('sameAddr').checked,
            corr_street: v('corrStreet'), corr_city: v('corrCity'),
            // Step 4
            immigration_status: v('immStatus'), stay_purpose: v('stayPurpose'),
            arrival_date: v('arrivalDate'), permit_from: v('permitFrom'), permit_until: v('permitUntil'),
            permit_number: v('permitNo'), karta_pobytu: v('kartaPobytu'),
            previous_application: v('prevApp'), prev_app_details: v('prevAppDetails'),
            entry_ban: v('entryBan') === 'Yes', criminal_record: v('criminal') === 'Yes',
            service_needed: v('serviceNeeded'), immigration_notes: v('immNotes'),
            // Step 5
            marital_status: v('marital'), num_children: parseInt(v('numChildren')) || 0,
            dependents_in_poland: parseInt(v('dependents')) || 0, family_members: fm,
            // Step 6
            education_level: v('education'), field_of_study: v('fieldOfStudy'),
            institution: v('institution'), graduation_year: parseInt(v('gradYear')) || null,
            education_country: v('eduCountry'), polish_level: v('polishLevel'),
            other_languages: v('otherLangs'), employment_status: v('empStatus'),
            profession: v('profession'), employer_name: v('employer'),
            employer_nip: v('empNip'), employer_address: v('empAddress'),
            employment_since: v('empSince'), salary: parseFloat(v('salary')) || null,
            work_permit_type: v('workPermit'), work_permit_expiry: v('wpExpiry'),
            health_insurance: v('healthIns'), bank_account_poland: v('bankAccount') === 'Yes',
            tax_residency: v('taxRes'),
            // Step 7
            agreed_terms: document.getElementById('agreeTerms').checked,
            agreed_rodo: document.getElementById('agreeRodo').checked,
            agreed_poa: document.getElementById('agreePoa').checked,
            agreed_data_sharing: document.getElementById('agreeData').checked,
            agreed_marketing: document.getElementById('agreeMarketing').checked,
            digital_signature: v('digitalSignature')
        };
    }
    ...
    btnSubmit.addEventListener('click', function(){
        ...
        .then(function(result){
            if(result.success) {
                ...
                Swal.fire({icon:'error', title: t('wc-reg-swal-error','Error'), html: errs, confirmButtonColor:'#015EA7'});
            }
            self.disabled = false;
