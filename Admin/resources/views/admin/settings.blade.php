                        ...
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#25D366;">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" value="+48 579 266 493" readonly>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fs-12">Business Account ID</label>
                                    <input type="text" class="form-control form-control-sm" value="1098374628" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">API Token</label>
                                    <input type="password" class="form-control form-control-sm" value="EAABs...hidden" readonly>
                                </div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#0088cc;">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="password" class="form-control form-control-sm" value="bot7291...hidden" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Webhook URL</label>
                                    <input type="url" class="form-control form-control-sm" value="https://wincase.eu/api/tg/webhook" readonly>
                                </div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#6c757d;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded bg-secondary-subtle text-secondary">
                                            <i class="ri-mail-fill fs-18"></i>
                                        </div>
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Email Address</label>
                                    <input type="email" class="form-control form-control-sm" value="biuro@wincase.eu" readonly>
                                </div>
                                <div class="row g-2 mb-2">
                                    <div class="col-8"><label class="form-label fs-12">IMAP Host</label><input type="text" class="form-control form-control-sm" value="mail.wincase.eu" readonly></div>
                                    <div class="col-4"><label class="form-label fs-12">Port</label><input type="text" class="form-control form-control-sm" value="993" readonly></div>
                                </div>
                                <div class="row g-2 mb-3">
                                    <div class="col-8"><label class="form-label fs-12">SMTP Host</label><input type="text" class="form-control form-control-sm" value="mail.wincase.eu" readonly></div>
                                    <div class="col-4"><label class="form-label fs-12">Port</label><input type="text" class="form-control form-control-sm" value="465" readonly></div>
                                </div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#0d6efd;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded bg-primary-subtle text-primary">
                                            <i class="ri-message-2-fill fs-18"></i>
                                        </div>
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Provider</label>
                                    <select class="form-select form-select-sm"><option>Select provider...</option><option>Twilio</option><option>SMSAPI.pl</option><option>SerwerSMS</option><option>SMSLabs</option></select>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label fs-12">API Key</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter API key">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Sender Number / Name</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="+48... or WinCase">
                                </div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#1877F2;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded" style="background:rgba(24,119,242,.12); color:#1877F2;">
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Page ID</label>
                                    <input type="text" class="form-control form-control-sm" value="108273649201" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Page Access Token</label>
                                    <input type="password" class="form-control form-control-sm" value="EAABs...hidden" readonly>
                                </div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#E4405F;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded" style="background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888); color:#fff;">
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Business Account ID</label>
                                    <input type="text" class="form-control form-control-sm" value="17841405829104" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Access Token</label>
                                    <input type="password" class="form-control form-control-sm" value="IGQV...hidden" readonly>
                                </div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#000;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded bg-dark text-white">
                                            <i class="ri-threads-fill fs-18"></i>
                                        </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" placeholder="@wincase">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">API Token</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter API token">
                                </div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#E60023;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded" style="background:rgba(230,0,35,.12); color:#E60023;">
                                            <i class="ri-pinterest-fill fs-18"></i>
                                        </div>
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">App ID</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter App ID">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Access Token</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter access token">
                                </div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#010101;">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Business ID</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter Business ID">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Access Token</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter access token">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0 intg-ch-card" style="--ch-color:#7360F2;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm avatar-rounded" style="background:rgba(115,96,242,.12); color:#7360F2;">
                                            <i class="ri-chat-smile-2-fill fs-18"></i>
                                        </div>
                                ...
                                <div class="mb-2">
                                    <label class="form-label fs-12">Bot Name</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="WinCase Bot">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fs-12">Auth Token</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter auth token">
                                </div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-3"><label class="form-label fs-12">API Key</label><input type="password" class="form-control form-control-sm" value="AIzaSy...hidden" readonly></div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-2"><label class="form-label fs-12">App ID</label><input type="text" class="form-control form-control-sm" value="123456789" readonly></div>
                                <div class="mb-3"><label class="form-label fs-12">App Secret</label><input type="password" class="form-control form-control-sm" value="hidden-secret" readonly></div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-3"><label class="form-label fs-12">Access Token</label><input type="text" class="form-control form-control-sm" placeholder="Enter access token"></div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-3"><label class="form-label fs-12">API Key</label><input type="text" class="form-control form-control-sm" placeholder="Enter API key"></div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-3"><label class="form-label fs-12">Terminal</label><input type="text" class="form-control form-control-sm" value="Terminal #1 - PAX A920" readonly></div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-3"><label class="form-label fs-12">Webhook URL</label><input type="url" class="form-control form-control-sm" value="https://n8n.wincase.eu/webhook/crm" readonly></div>
                                <button class="btn btn-sm btn-subtle-danger w-100"><i class="ri-link-unlink me-1"></i>Disconnect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-2"><label class="form-label fs-12">Client ID</label><input type="text" class="form-control form-control-sm" placeholder="Enter OAuth Client ID"></div>
                                <div class="mb-3"><label class="form-label fs-12">Client Secret</label><input type="text" class="form-control form-control-sm" placeholder="Enter client secret"></div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-2"><label class="form-label fs-12">Vault Path / URL</label><input type="text" class="form-control form-control-sm" placeholder="Local path or Obsidian Sync URL"></div>
                                <div class="mb-3"><label class="form-label fs-12">API Token (Obsidian REST)</label><input type="text" class="form-control form-control-sm" placeholder="Enter token"></div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-2"><label class="form-label fs-12">Integration Token</label><input type="text" class="form-control form-control-sm" placeholder="secret_..."></div>
                                <div class="mb-3"><label class="form-label fs-12">Database ID</label><input type="text" class="form-control form-control-sm" placeholder="Enter database ID"></div>
                                <button class="btn btn-sm btn-subtle-primary w-100"><i class="ri-link me-1"></i>Connect</button>
                            </div>
                        </div>
                    </div>
...
// ===============================================================
// INTEGRATIONS — CONNECT / DISCONNECT BUTTONS
// ===============================================================
document.querySelectorAll('#tab-integrations .btn-subtle-primary, #tab-integrations .btn-subtle-danger').forEach(function(btn) {
    if (btn.textContent.includes('Connect') || btn.textContent.includes('Disconnect')) {
        btn.addEventListener('click', function(e) {
            e.preventDefault();
            var card = this.closest('.card');
            var name = card?.querySelector('h6')?.textContent || 'Integration';
            var isConnect = this.textContent.includes('Connect') && !this.textContent.includes('Dis');

            if (isConnect) {
                // Collect fields from card
                var inputs = card.querySelectorAll('input:not([readonly]), select');
                var data = {};
                var valid = true;
                inputs.forEach(function(inp) {
                    var label = inp.closest('.mb-2, .mb-3, .mb-1')?.querySelector('label')?.textContent?.trim() || '';
                    var val = inp.value.trim();
                    if (!val && inp.getAttribute('placeholder')) {
                        valid = false;
                ...
                .then(function() {
                    ...
                    if (badge) { badge.className = 'badge bg-success-subtle text-success'; badge.textContent = 'Connected'; }
                    btn.className = 'btn btn-sm btn-subtle-danger w-100';
                    btn.innerHTML = '<i class="ri-link-unlink me-1"></i>Disconnect';
                ...
                .catch(function() {
                    ...
                    btn.innerHTML = '<i class="ri-link-unlink me-1"></i>Disconnect';
                    inputs.forEach(function(inp) { inp.setAttribute('readonly', true); });
                    showToast(name + ' connected (local)', 'info');
                });
            } else {
                // Disconnect
                if (!confirm('Disconnect ' + name + '?')) return;

                fetch('/api/settings/integrations/disconnect', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content || '' },
                ...
                .then(function() {
                    var badge = card.querySelector('.badge');
                    if (badge) { badge.className = 'badge bg-warning-subtle text-warning'; badge.textContent = 'Not Connected'; }
                    btn.className = 'btn btn-sm btn-subtle-primary w-100';
                    btn.innerHTML = '<i class="ri-link me-1"></i>Connect';
                    card.querySelectorAll('input[readonly]').forEach(function(inp) {
                        if (!inp.classList.contains('text-success')) {
                ...
                .catch(function() {
                    ...
                    btn.className = 'btn btn-sm btn-subtle-primary w-100';
                    btn.innerHTML = '<i class="ri-link me-1"></i>Connect';
                    showToast(name + ' disconnected (local)', 'info');
                });
            }
        });
    }
