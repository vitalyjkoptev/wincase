...
const ATTRIBUTES = {
  ...
  LAYOUT_CONTAINER: 'data-layout-container',
  PAGE_LOADER: 'data-page-loader',
  AUTH_LAYOUT: 'AUTH_LAYOUT',
};

const DEFAULT_VALUES = {
  [ATTRIBUTES.MAIN_LAYOUT]: 'close-sidebar', // 'vertical', 'horizontal', 'two-column' , 'semi-boxed', 'compact, 'small-icon'
  ...
  [ATTRIBUTES.NAV_POSITION]: 'hidden', // 'sticky', 'static', 'hidden'
  ...
  [ATTRIBUTES.LAYOUT_CONTAINER]: 'fluid', // 'fluid', 'boxed'
  [ATTRIBUTES.PAGE_LOADER]: 'visible', // 'hidden', 'visible'
  [ATTRIBUTES.AUTH_LAYOUT]: typeof AUTH_LAYOUT === 'undefined' ? true : AUTH_LAYOUT,
};
