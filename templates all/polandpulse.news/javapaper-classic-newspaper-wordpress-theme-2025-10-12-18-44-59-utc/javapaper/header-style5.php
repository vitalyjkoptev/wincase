...
$num_posts = sprintf( _n( '%s Post', '%s Posts','javapaper', $num_posts ), number_format_i18n( $num_posts ) );

$num_cats  = wp_count_terms('category');
$num_tags  = wp_count_terms('post_tag');

echo '<div class="total-assetscontent">' . $num_posts . '</div>';
echo '<div class="total-assetscontent"> ' . $num_cats . ' Categories</div>';
echo '<div class="total-assetscontent">' . $num_tags . ' Tags</div>';
?>
          </div>
        </div>
      </div>
  ...
  <div class="mainnav-navwrapperboxed">
    <div class="nav-mainwrapper">
      <div class="mainnav-inside">
        <nav id="site-navigation" class="header5-nav" role="navigation">
          <!-- open Sidebar1 menu -->
