...
<div class="singlecpt-wrapper">
  ...
  <div id="primary" class="site-content <?php if(isset($redux_demo['jp_sidebar']) ){ ?><?php echo esc_html($redux_demo['jp_sidebar']); ?><?php } ?>">
    <div id="content" role="main">
          ...
          <div class="cpt-desc">
            <div class="row">
              ...
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo  get_post_meta($post->ID, "event_schedule", true ); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
              <?php if( get_post_meta($post->ID, "Place", true) ): ?>
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo get_post_meta($post->ID, "Place", true); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
              <?php if( get_post_meta($post->ID, "Contact", true) ): ?>
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo get_post_meta($post->ID, "Contact", true); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
              <?php if( get_post_meta($post->ID, "event_description1", true) ): ?>
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo get_post_meta($post->ID, "event_description1", true); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
              <?php if( get_post_meta($post->ID, "Event_description2", true) ): ?>
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo get_post_meta($post->ID, "Event_description2", true); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
              <?php if( get_post_meta($post->ID, "Event_description3", true) ): ?>
              <div class="col-md-12 cptfield">
                <div class="cpt-inside"> <?php echo get_post_meta($post->ID, "Event_description3", true); ?> </div>
              </div>
              <?php else : ?>
              <?php endif; ?>
            </div>
      ...
      <div class="col-md-8">
        <?php get_template_part( 'page-templates/contentevent', get_post_format() ); ?>
