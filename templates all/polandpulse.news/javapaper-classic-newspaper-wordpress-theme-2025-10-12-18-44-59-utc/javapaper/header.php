...
<div class="wrapper-header">
            ...
            <div class="simple-marquee-container">
              <div class="marquee-wrapper">
                <div class="marquee-sibling">
                  <?php esc_attr_e(" LATEST ","javapaper"); ?>
                </div>
              </div>
              <div class="marquee">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-6 mainheader">
              <div class="javapaperlogo">
                ...
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>"> <img alt="<?php echo get_bloginfo('name'); ?>" src="<?php if( isset($redux_demo['opt_header_logo']) ){ ?><?php echo esc_url($redux_demo['opt_header_logo']['url']); ?><?php } ?>"></a>
                <?php } 
                ...
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>"> <img src="<?php echo esc_url( get_template_directory_uri() . '/images/logo.png' ); ?>" alt="<?php echo get_bloginfo('name'); ?>" > </a>
                <?php } 
			  ?>
              </div>
            </div>
            <div class="col-md-3">
              ...
              <div class="sosmed"> <a href="<?php  echo esc_url($redux_demo['jp_socmedlink1']); ?>"> <img src="<?php if($redux_demo['jp_socmedimg1']['url']):echo esc_url($redux_demo['jp_socmedimg1']['url']); endif; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_attr($redux_demo['jp_socmedalt1']); ?>" class="tip-bottom" alt="<?php esc_attr_e('socmed', 'javapaper' ); ?>"> </a> </div>
              <?php endif; ?>
          ...
          <div class="mainnav-inside">
            <div class="nav-main">
              <nav id="site-navigation" class="javapaper-nav" role="navigation"> <a class="assistive-text" href="#main" title="<?php esc_attr_e( 'Skip to content', 'javapaper' ); ?>">
                ...
                <?php wp_nav_menu( array( 'theme_location' => 'primary_menu', 'menu_id' => 'menu-top', 'menu_class' => 'nav-menu', 'container' => 'ul','depth' => 5 ) ); ?>
              </nav>
              <!-- #site-navigation -->
            </div>
          </div>
  ...
  <div class="Sidebar1">
    ...
    <div class="logo">
      <div class="javapaperlogo">
        <?php global $redux_demo; if ( isset($redux_demo['opt_header_logo']['url']) ){ ?>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"> <img alt="<?php echo get_bloginfo('name'); ?>" src="<?php if( isset($redux_demo['opt_header_logo']) ){ ?>
