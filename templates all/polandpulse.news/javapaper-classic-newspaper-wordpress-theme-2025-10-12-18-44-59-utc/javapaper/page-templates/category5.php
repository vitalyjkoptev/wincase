<div class="category1-topheader">
  <div class="category1-topinside">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <div class="cat-about"> 
          <?php esc_html_e( 'ABOUT THIS CATEGORY', 'javapaper' ); ?>
        </div>	  
      ...
      <div class="category1-wrapper">
        ...
        <div class="category5-jtop col-md-6">
          <div <?php post_class('clearfix'); ?> >
            <?php get_template_part( 'page-templates/catcontent5', get_post_format() ); ?>
          </div>
        </div>
        <?php endwhile; ?>
        <?php else : ?>
        <?php get_template_part( 'page-templates/content5', 'none' ); ?>
        <?php endif; ?>
      </div>
    </div>
    <!-- #content -->
