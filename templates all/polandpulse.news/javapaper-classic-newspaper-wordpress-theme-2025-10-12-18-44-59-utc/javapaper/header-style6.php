...
<link rel="shortcut icon" href="<?php if( isset($redux_demo['jp_favicon']['url']) ){ ?><?php echo esc_url($redux_demo['jp_favicon']['url']); ?><?php } else {?><?php } ?>"/>
<?php } else { ?>
<?php } ?>
<?php wp_head(); ?>
</head>
...
<?php } ?>"> </a>
            ...
            <nav id="site-navigation" class="javapaper-nav col-md-10" role="navigation"> <a class="assistive-text" href="#main" title="<?php esc_attr_e( 'Skip to content', 'javapaper' ); ?>">
