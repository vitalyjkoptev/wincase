...
@section('title', 'Multichat — WinCase CRM')
@section('page-title', 'Multichat')
...
<style>
    ...
    .mc-cl-manager { font-size:.6rem; color:#999; }
...
<div class="row g-2 mb-2">
    <div class="col"><div class="card mb-0"><div class="card-body py-2 text-center"><div class="fs-4 fw-bold text-success">147</div><div class="text-muted" style="font-size:.65rem;">Conversations</div></div></div></div>
    <div class="col"><div class="card mb-0"><div class="card-body py-2 text-center"><div class="fs-4 fw-bold text-primary">23</div><div class="text-muted" style="font-size:.65rem;">Active Today</div></div></div></div>
    <div class="col"><div class="card mb-0"><div class="card-body py-2 text-center"><div class="fs-4 fw-bold text-warning">8</div><div class="text-muted" style="font-size:.65rem;">Awaiting Reply</div></div></div></div>
    <div class="col"><div class="card mb-0"><div class="card-body py-2 text-center"><div class="fs-4 fw-bold text-danger">3</div><div class="text-muted" style="font-size:.65rem;">Overdue >24h</div></div></div></div>
</div>
...
<div class="mc-wrap">
    ...
    <div class="mc-left" id="mcLeft">
        <div class="mc-left-head">
            ...
            <span class="mc-title">Clients</span>
        ...
        <div class="mc-left-search">
            <input type="text" class="form-control form-control-sm" placeholder="Search clients..." id="clSearch">
        </div>
        <div class="mc-left-tabs">
            <div class="lt active" data-f="all">All <span class="badge bg-secondary rounded-pill" style="font-size:.5rem;">12</span></div>
            <div class="lt" data-f="unread">Unread <span class="badge bg-danger rounded-pill" style="font-size:.5rem;">5</span></div>
            <div class="lt" data-f="overdue">Overdue <span class="badge bg-warning rounded-pill" style="font-size:.5rem;">2</span></div>
        </div>
        <div class="mc-clients" id="clientList">
            <!-- Client 1: Olena -->
            <div class="mc-cl active" data-client="olena" data-manager="Anna K." data-unread="3">
                ...
                <div class="mc-cl-body">
                    ...
                    <div class="mc-cl-meta">
                        ...
                        <span class="mc-cl-manager">Anna K.</span>
                        <span class="mc-cl-unread">3</span>
                    </div>
                </div>
            </div>
            <!-- Client 2: Dmytro -->
            <div class="mc-cl" data-client="dmytro" data-manager="Anna K." data-unread="1">
            ...
            <!-- Client 3: Chen Wei - overdue -->
            <div class="mc-cl" data-client="chen" data-manager="Tomasz W." data-overdue="1">
                ...
                <div class="mc-cl-body">
                    ...
                    <div class="mc-cl-meta">
                        ...
                        <span class="mc-cl-manager">Tomasz W.</span>
                        <span class="ms-auto badge bg-danger" style="font-size:.5rem;">OVERDUE</span>
                    </div>
                </div>
            </div>
            <!-- Client 4: Rahul -->
            <div class="mc-cl" data-client="rahul" data-manager="Anna K." data-unread="1">
            ...
            <!-- Client 5: Mehmet -->
            <div class="mc-cl" data-client="mehmet" data-manager="Maria N." data-unread="1">
                ...
                <div class="mc-cl-body">
                    ...
                    <div class="mc-cl-meta">
                        ...
                        <span class="mc-cl-manager">Maria N.</span>
                        <span class="mc-cl-unread">1</span>
                    </div>
                </div>
            </div>
            <!-- Client 6: Irina -->
            <div class="mc-cl" data-client="irina" data-manager="Oksana L." data-unread="1">
                ...
                <div class="mc-cl-body">
                    ...
                    <div class="mc-cl-meta">
                        ...
                        <span class="mc-badge" style="background:#6c757d;">EM</span>
                        <span class="mc-cl-unread">1</span>
                        <span class="mc-cl-manager">Oksana L.</span>
                    </div>
                </div>
            </div>
            <!-- Client 7: Maria Garcia - overdue -->
            <div class="mc-cl" data-client="maria-g" data-manager="Pawel K." data-overdue="1">
                ...
                <div class="mc-cl-body">
                    ...
                    <div class="mc-cl-meta">
                        <span class="mc-badge" style="background:#6c757d;">EM</span>
                        <span class="mc-cl-manager">Pawel K.</span>
                        <span class="ms-auto badge bg-danger" style="font-size:.5rem;">OVERDUE</span>
                    </div>
                </div>
            </div>
            <!-- Client 8: Viktor -->
            <div class="mc-cl" data-client="viktor" data-manager="Anna K.">
    ...
    <div class="mc-center">
        <div class="mc-chat-head">
            ...
            <div class="flex-grow-1">
                ...
                <div style="font-size:.68rem;color:#888;" id="chatMeta">Case #WC-2026-0847 &bull; Temporary Residence Permit &bull; <strong class="text-success">Anna Kowalska</strong></div>
            </div>
        ...
        <div class="mc-msgs" id="mcMsgs">
            ...
            <div class="mc-row out" data-from="olena" data-channel="portal">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> Anna Kowalska</div>
            ...
            <div class="mc-row out" data-from="mehmet" data-channel="whatsapp">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> Maria Nowak</div>
            ...
            <div class="mc-date"><span>Today, March 2, 2026</span></div>
            ...
            <div class="mc-row" data-from="olena" data-channel="portal">
                <div class="mc-bub in">
                    ...
                    <div class="mc-t">10:45</div>
                </div>
            </div>
            <div class="mc-row" data-from="rahul" data-channel="portal">
                <div class="mc-bub in">
                    <div class="mc-who" style="color:#ff5722;">Rahul Sharma</div>
                    <div class="mc-ch" style="color:#015EA7;"><i class="ri-globe-line"></i> Client Portal</div>
                    I uploaded the passport copy to the portal. Please check.
                    <div class="mc-file"><i class="ri-attachment-line"></i> passport_front.jpg <span class="text-muted">(3.4 MB)</span></div>
                    <div class="mc-t">11:02</div>
                </div>
            </div>
            ...
            <div class="mc-row out" data-from="mehmet" data-channel="facebook">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> WinCase Page</div>
            ...
            <div class="mc-row out" data-from="irina" data-channel="instagram">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> WinCase IG</div>
            ...
            <div class="mc-row out" data-from="olena" data-channel="threads">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> WinCase Threads</div>
            ...
            <div class="mc-row out" data-from="rahul" data-channel="pinterest">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> WinCase Pinterest</div>
                    <div class="mc-ch"><i class="ri-pinterest-line"></i> PIN Reply</div>
                    Yes, the checklist is current! We update it monthly. Thanks for saving!
                    <div class="mc-t">14:40</div>
                </div>
            </div>
            ...
            <div class="mc-row out" data-from="chen" data-channel="tiktok">
                <div class="mc-bub out">
                    <div class="mc-who"><i class="ri-user-line"></i> WinCase TikTok</div>
                    <div class="mc-ch"><i class="ri-tiktok-line"></i> TT Reply</div>
                    Hi Chen! Yes, we work with Chinese documents. Please email us the scan and we'll arrange certified translation.
                    <div class="mc-t">16:00</div>
                </div>
            </div>
        </div>
        ...
        <div class="mc-input">
            <div class="mc-reply-bar">
                ...
                <span class="ms-auto" style="font-size:.6rem;color:#015EA7;"><i class="ri-shield-keyhole-line"></i> as <strong>Director</strong></span>
            </div>
            ...
            <div class="d-flex gap-2 align-items-end">
                ...
                <textarea class="form-control" placeholder="Type a message as Director..." id="bossInput" rows="6" style="resize:vertical;min-height:120px;font-size:.85rem;"></textarea>
                <button class="btn btn-success btn-sm px-3" type="button" id="bossSend"><i class="ri-send-plane-line"></i></button>
            </div>
            <div class="mc-drag-hint"><i class="ri-drag-move-line"></i> Drag any message here to quote & reply via its channel</div>
            <div class="mc-qbtns">
                <span class="mc-qb"><i class="ri-check-line"></i> Approve</span>
                <span class="mc-qb"><i class="ri-user-shared-line"></i> Reassign</span>
                <span class="mc-qb"><i class="ri-eye-line"></i> Reviewed</span>
                <span class="mc-qb"><i class="ri-notification-3-line"></i> Remind</span>
    ...
    <div class="mc-right" id="mcRight">
        ...
        <div class="mc-card" id="infoCase">
            ...
            <div class="mc-card-row"><span>Manager</span><strong class="text-success">Anna K.</strong></div>
        </div>
        <!-- Channels -->
        ...
        <!-- SLA -->
        <div class="mc-card">
            <div class="mc-card-title"><i class="ri-timer-line me-1"></i>Response</div>
            <div class="mc-card-row"><span>Avg reply</span><strong>12 min</strong></div>
            <div class="mc-card-row"><span>Last reply</span><span>09:52</span></div>
...
function highlightMessages(clientId){
    ...
    // Clear dimmed after 3s — show all but keep highlight
    setTimeout(function(){
...
// Client info data
var clientData = {
    olena:   { name:'Olena Kovalenko', av:'OK', color:'rgba(1,94,167,.15)', textColor:'#015EA7', country:'Ukraine', age:28, phone:'+48 512 XXX', email:'olena@gmail.com', caseNum:'#WC-2026-0847', caseType:'TRP', stage:'Awaiting Decision', stageClass:'bg-warning', day:'47 / ~90', manager:'Anna K.' },
    dmytro:  { name:'Dmytro Bondarenko', av:'DB', color:'rgba(13,110,253,.15)', textColor:'#0d6efd', country:'Ukraine', age:35, phone:'+48 501 XXX', email:'dmytro@ukr.net', caseNum:'#WC-2026-0812', caseType:'Work Permit', stage:'Fingerprint Appt.', stageClass:'bg-info', day:'30', manager:'Anna K.' },
    chen:    { name:'Chen Wei', av:'CW', color:'rgba(255,152,0,.15)', textColor:'#ff9800', country:'China', age:33, phone:'+48 505 XXX', email:'chen@qq.com', caseNum:'#WC-2026-0870', caseType:'TRP', stage:'Pending Docs', stageClass:'bg-danger', day:'12', manager:'Tomasz W.' },
    rahul:   { name:'Rahul Sharma', av:'RS', color:'rgba(255,87,34,.15)', textColor:'#ff5722', country:'India', age:31, phone:'+48 509 XXX', email:'rahul@gmail.com', caseNum:'#WC-2026-0831', caseType:'TRP', stage:'Awaiting Decision', stageClass:'bg-warning', day:'5', manager:'Anna K.' },
    mehmet:  { name:'Mehmet Yilmaz', av:'MY', color:'rgba(233,30,99,.15)', textColor:'#e91e63', country:'Turkey', age:29, phone:'+48 515 XXX', email:'mehmet@hot.com', caseNum:'#WC-2026-0855', caseType:'Work Permit Ext.', stage:'Submitted', stageClass:'bg-primary', day:'3', manager:'Maria N.' },
    irina:   { name:'Irina Kozlova', av:'IK', color:'rgba(156,39,176,.15)', textColor:'#9c27b0', country:'Belarus', age:42, phone:'+48 520 XXX', email:'irina@mail.ru', caseNum:'#WC-2026-0798', caseType:'Permanent Res.', stage:'Awaiting Decision', stageClass:'bg-warning', day:'83 / ~90', manager:'Oksana L.' },
    'maria-g': { name:'Maria Garcia', av:'MG', color:'rgba(121,85,72,.15)', textColor:'#795548', country:'Spain', age:27, phone:'+48 530 XXX', email:'maria@esp.com', caseNum:'#WC-2026-0878', caseType:'Student Visa', stage:'Pending Docs', stageClass:'bg-danger', day:'8', manager:'Pawel K.' },
    viktor:  { name:'Viktor Morozov', av:'VM', color:'rgba(63,81,181,.15)', textColor:'#3f51b5', country:'Ukraine', age:45, phone:'+48 502 XXX', email:'vik@ukr.net', caseNum:'#WC-2026-0790', caseType:'Work Permit', stage:'Card Issued', stageClass:'bg-success', day:'148', manager:'Anna K.' }
};
...
function updateHeader(el){
    ...
    document.getElementById('chatMeta').innerHTML = 'Case ' + d.caseNum + ' &bull; ' + d.caseType + ' &bull; <strong class="text-success">' + d.manager + '</strong>';
    // Update right panel
    ...
    document.getElementById('infoCase').innerHTML = '<div class="mc-card-title"><i class="ri-briefcase-line me-1"></i>Case</div>' +
        ...
        '<div class="mc-card-row"><span>Manager</span><strong class="text-success">' + d.manager + '</strong></div>';
}
...
document.querySelectorAll('.mc-ch-filter').forEach(function(badge){
    badge.addEventListener('click', function(){
        ...
        // Toggle off if same channel clicked again
...
// ===== Send message =====
document.getElementById('bossSend').addEventListener('click', sendBossMsg);
document.getElementById('bossInput').addEventListener('keydown', function(e){ if(e.key==='Enter' && !e.shiftKey){ e.preventDefault(); sendBossMsg(); } });
function sendBossMsg(){
    ...
    row.innerHTML = '<div class="mc-bub out highlighted"><div class="mc-who"><i class="ri-shield-keyhole-line"></i> Dmitry Sokolov (Director)</div><div class="mc-ch"><i class="ri-globe-line"></i> ' + chName + '</div>' + quoteHtml + input.value.replace(/\n/g,'<br>') + '<div class="mc-t">' + new Date().toLocaleTimeString('en',{hour:'2-digit',minute:'2-digit'}) + '</div></div>';
...
document.querySelectorAll('.mc-row').forEach(function(row){
    ...
    bub.addEventListener('dragstart', function(e){
        ...
        // Get pure text (skip channel label and who)
